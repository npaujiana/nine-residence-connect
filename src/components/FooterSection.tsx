...
const FooterSection = () => {
  return (
    <footer className="bg-nine-dark text-white py-12 px-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="text-xl font-bold mb-4">Nine<span className="text-nine-accent">Residence</span></div>
            <p className="text-gray-300 text-sm">
              Modern co-living space designed for teenagers with digital room management and vibrant community features.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 text-sm">123 Residence St</li>
              <li className="text-gray-300 text-sm">Jakarta, Indonesia</li>
              <li className="text-gray-300 text-sm">info@nineresidence.com</li>
              <li className="text-gray-300 text-sm">+62 (21) 123-4567</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-gray-400 mb-4 md:mb-0">
            © {new Date().getFullYear()} Nine Residence. All rights reserved.
          </div>
